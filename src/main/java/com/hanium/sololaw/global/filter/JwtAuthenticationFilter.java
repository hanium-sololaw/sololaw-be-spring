 ...
 */
package com.hanium.sololaw.global.filter;
 ...
 * @see com.hanium.sololaw.global.security.CustomUserDetailsService
 * @see com.hanium.sololaw.global.security.CustomUserDetails
 */
@Slf4j
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected boolean shouldNotFilter(HttpServletRequest request) {
    ...
    if ("/error".equals(uri) || "/favicon.ico".equals(uri)) {
      return true;
    }
