...
public class SubscriptionController {
  ...
  @Operation(
      ...
      description =
          """
            **Parameters**  \n
            plan: 구독할 플랜(STANDARD, PRO — FREE는 결제 대상이 아님) \n
            \n
            **Returns**  \n
  ...
  public ResponseEntity<BaseResponse<CheckoutResponse>> checkout(
    ...
    CheckoutResponse result = subscriptionService.checkout(user, request);
    return ResponseEntity.ok(BaseResponse.success(result));
  }
      ...
      description =
          """
            ...
            **Returns**  \n
            ...
            """)
  @PostMapping("/confirm")
  public ResponseEntity<BaseResponse<SubscriptionResponse>> confirm(
      ...
      description =
          """
            **Returns**  \n
            ...
            """)
  @PostMapping("/cancel")
  public ResponseEntity<BaseResponse<SubscriptionResponse>> cancel(@CurrentUser User user) {
