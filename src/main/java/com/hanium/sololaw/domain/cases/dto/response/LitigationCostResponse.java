...
@Schema(description = "소송비용(인지대·송달료·변호사보수 인정액) 산출 응답 DTO")
public record LitigationCostResponse(
    ...
    @Schema(description = "인지액 + 송달료(변호사보수 인정액은 미포함)", example = "214200") long totalCost,
    @Schema(description = "변호사보수 소송비용 산입 인정액(참고용, 위 합계에는 포함되지 않음)", example = "1000000")
        long attorneyFeeCap,
